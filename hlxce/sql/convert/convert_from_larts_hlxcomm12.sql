...
RENAME TABLE `hlstats_Awards_History` TO `hlstats_Players_Awards`;
...
CHANGE `awardCount` `count` int(11) unsigned NOT NULL default '0';
...
CHANGE COLUMN `map_name` `map` varchar(128) character set utf8 collate utf8_unicode_ci default NULL,
