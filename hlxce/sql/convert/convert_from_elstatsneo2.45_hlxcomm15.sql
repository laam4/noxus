...
UPDATE `hlstats_Actions` SET `code` = 'flagevent_defended' WHERE `code` = 'flagevent' AND `event` = 'defended' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'flagevent_captured' WHERE `code` = 'flagevent' AND `event` = 'captured' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'flagevent_dropped', `description` = 'Dropped the flag (while alive)' WHERE `code` = 'flagevent' AND `event` = 'dropped' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'flagevent_picked_up' WHERE `code` = 'flagevent' AND `event` = 'picked up' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'killedobject_obj_teleporter_exit' WHERE `code` = 'killedobject' AND `object` = 'OBJ_TELEPORTER_EXIT' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'killedobject_obj_teleporter_entrance' WHERE `code` = 'killedobject' AND `object` = 'OBJ_TELEPORTER_ENTRANCE' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'killedobject_obj_dispenser' WHERE `code` = 'killedobject' AND `object` = 'OBJ_DISPENSER' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'killedobject_obj_sentrygun' WHERE `code` = 'killedobject' AND `object` = 'OBJ_SENTRYGUN' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'killedobject_obj_attachment_sapper' WHERE `code` = 'killedobject' AND `object` = 'OBJ_ATTACHMENT_SAPPER' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'builtobject_obj_teleporter_exit' WHERE `code` = 'builtobject' AND `object` = 'OBJ_TELEPORTER_EXIT' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'builtobject_obj_teleporter_entrance' WHERE `code` = 'builtobject' AND `object` = 'OBJ_TELEPORTER_ENTRANCE' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'builtobject_obj_dispenser' WHERE `code` = 'builtobject' AND `object` = 'OBJ_DISPENSER' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'builtobject_obj_sentrygun' WHERE `code` = 'builtobject' AND `object` = 'OBJ_SENTRYGUN' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'builtobject_obj_attachment_sapper' WHERE `code` = 'builtobject' AND `object` = 'OBJ_ATTACHMENT_SAPPER' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'owner_killedobject_obj_teleporter_exit' WHERE `code` = 'owner_killedobject' AND `object` = 'OBJ_TELEPORTER_EXIT' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'owner_killedobject_obj_teleporter_entrance' WHERE `code` = 'owner_killedobject' AND `object` = 'OBJ_TELEPORTER_ENTRANCE' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'owner_killedobject_obj_dispenser' WHERE `code` = 'owner_killedobject' AND `object` = 'OBJ_DISPENSER' AND `game` = 'tf';
UPDATE `hlstats_Actions` SET `code` = 'owner_killedobject_obj_sentrygun' WHERE `code` = 'owner_killedobject' AND `object` = 'OBJ_SENTRYGUN' AND `game` = 'tf';
...
CHANGE `awardType` `awardType` CHAR( 1 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'W';
...
('W','tf','flaregun', 'Flaregun', 'kills with flaregun'),
...
DROP TABLE `hlstats_Events_Streaks`;
...
DELETE FROM hlstats_Options WHERE `game` <> 'ELSTATSNEO';
...
CHANGE `last_event` `last_event` INT( 11 ) NOT NULL DEFAULT '0';

TRUNCATE TABLE `hlstats_Ranks`;

ALTER TABLE `hlstats_Ranks`
ADD UNIQUE KEY `rankgame` (`image`,`game`);
...
TRUNCATE TABLE `hlstats_Ribbons`;

ALTER TABLE `hlstats_Ribbons`
ADD UNIQUE KEY `award` (`awardCode`,`awardCount`,`game`, `special`);
...
CHANGE `sortorder` `sortorder` tinyint NOT NULL default '0',
...
DELETE FROM `hlstats_Servers_Config` WHERE `parameter` IN ('AdminContact','BroadCastEventsCommandSteamid','MasterServerData','MasterServerInterval','PlayerEventsCommandSteamid','RawSocketHelpNotice','RawSocketSupport');

DELETE FROM `hlstats_Servers_Config_Default` WHERE `parameter` IN ('AdminContact','BroadCastEventsCommandSteamid','MasterServerData','MasterServerInterval','PlayerEventsCommandSteamid','RawSocketHelpNotice','RawSocketSupport');

ALTER TABLE `hlstats_Servers_Teamspeak`
ADD UNIQUE KEY `address` (`tsAddr`,`tsUDPPort`);
